...
async fn main() {
    ...
    let cliente = ClienteNf {
        nome: "Aquarius Viagens e Turismo LTDA".to_string(),
        cpf_cnpj: "03879292000172".to_string(),
        rua: "Avenida dos Andradas".to_string(),
        numero: Some("2287".to_string()),
        bairro: "Santa Efigenia".to_string(),
        cidade: "Belo horizonte".to_string(),
        estado: "MG".to_string(),
        complemento: Some("sala 1207".to_string()),
        gera_nf: true,
        cep: "30120010".to_string(),
        email: "amorimmaori@gmail.com".to_string(),
    };

//    gera_nfs(&cliente, 69.90).await;
